...
final class SettingsPresenceTests: XCTestCase {
    ...
    func testDictationTabCardPresence() throws {
        ...
        let cardTitles = try dictationTab.findAll(ViewType.Text.self)
            .compactMap { try $0.string() }
            .filter { $0 == "Shortcut" || $0 == "Magic Transform" || $0 == "Engine" || $0 == "Transcription Output" }
        ...
        XCTAssertTrue(cardTitles.contains("Transcription Output"), "Should contain Transcription Output card")
    }
